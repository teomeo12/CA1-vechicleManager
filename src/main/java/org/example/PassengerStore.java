...
//               // LocationGPS loc = new LocationGPS(newLatitude,newLongitude);
//
//                passengerList.set(p.setName(newName),p.setEmail(newEmail),p.setPhone(newPhone),p.setLocation(newLatitude,newLongitude));
